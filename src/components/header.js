    ...
    <header className="py-10 relative">
      <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start">
        <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
          <div className="flex items-center justify-between w-full md:w-auto text-2xl font-bold">
              ...
              <div className="mt-1 px-2 pt-2 pb-3 space-y-1">
                <Link
                  ...
                  className={cx(
                    ...
                    {
                      "border-green-500 text-green-500 bg-green-50 focus:text-green-600 focus:bg-green-100 focus:border-green-600":
                        location.pathname === "/",
                      "border-transparent text-gray-400 hover:text-gray-600 hover:bg-gray-50 hover:border-gray-300 focus:text-gray-600 focus:bg-gray-50 focus:border-gray-300":
                        !location.pathname === "/",
                    }
                  )}
                >
